...
public class RagDocumentController {
    ...
    @SaCheckPermission("document:reprocess")
    @PostMapping("/{fileHash}/reprocess")
    public ApiResponse<com.example.demo.model.dto.UploadResponse> reprocessDocument(@PathVariable String fileHash,
                                                                                    @RequestParam String userId) {
        return ragDocumentApplicationService.reprocessDocument(fileHash, authContextService.resolveUserId(userId));
    }
